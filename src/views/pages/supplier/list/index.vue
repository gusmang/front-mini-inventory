    ...
    <div>
        ...
        <v-dialog v-model="dialogDel" max-width="390">
            ...
            <v-card>
                ...
                <v-card-text>Are you sure want to delete supplier ?</v-card-text>
                <v-card-actions>
                    <v-spacer></v-spacer>
            ...
            <template v-slot:datatable>
                <v-flex md12 style="overflow-x: scroll">
                    <v-data-table :headers="headers" :items="listKategori" :options.sync="pagination"
                        :server-items-length="$store.state.supplier.attributes.total" :footer-props="{
                            ...
                            <v-dialog transition="dialog-top-transition" max-width="600">
                                ...
                                <template v-slot:default="dialog">
                                    <v-card>
                                        ...
                                        <v-text-field v-model="$store.state.supplier.editForm.id" hidden label="">
                                        </v-text-field>

                                        <v-container>
                                            <v-layout>
                                                <v-flex>
                                                    <v-text-field v-model="$store.state.supplier.editForm.name"
                                                        label="Nama Supplier">
                                                    </v-text-field>
                                                </v-flex>
                                            </v-layout>
                                            ...
                                            <v-layout>
                                                <v-flex>
                                                    <v-text-field v-model="$store.state.supplier.editForm.email"
                                                        label="Email">
                                                    </v-text-field>
                                                </v-flex>
                                            </v-layout>
                                            ...
                                            <v-layout>
                                                <v-flex>
                                                    <v-text-field v-model="$store.state.supplier.editForm.telepon"
                                                        label="No. Telepon">
                                                    </v-text-field>
                                                </v-flex>
                                            </v-layout>
                                            ...
                                            <v-layout>
                                                <v-flex>
                                                    <v-text-field v-model="$store.state.supplier.editForm.alamat"
                                                        label="Alamat">
                                                    </v-text-field>
                                                </v-flex>
                                            </v-layout>
...
export default {
    ...
    computed: {
        listKategori() {
            return this.$store.state.supplier.attributes.list.map(
                (items, index) => ({
                    ...items,
                    no: index + 1,
